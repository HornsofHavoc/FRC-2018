...
public class GripPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double blurRadius = 0.9433962264150947;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = blurOutput;
		double[] hsvThresholdHue = {61.038641220865266, 87.67147000723348};
		double[] hsvThresholdSaturation = {163.27683615819208, 255.0};
		double[] hsvThresholdValue = {79.2372881355932, 252.72727272727272};
		...
		double[] filterContoursSolidity = {21.06227106227106, 100.0};
